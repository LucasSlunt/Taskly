...
public class TeamMemberEntityTest {
    ...
    private Task createUniqueTask(Team team) {
        return new Task("Task_" + System.nanoTime(), "Description", team, false, "Open", TaskPriority.LOW, LocalDate.now());
    }
    ...
    void testDeleteTeamMemberRemovesAuthInfoButNotTeamsOrTasks() {
        ...
        Task task = new Task("Task_" + System.nanoTime(), "Description", team, false, "Open", TaskPriority.LOW, LocalDate.now());
        entityManager.persist(task);
        entityManager.flush();
